            ...
            <tr>
                <td>
                    <form class="contactForm" id="contactForm" method="POST" action="<?php echo htmlspecialchars($_SERVER[" PHP_SELF "]);?>">
                        ...
                        <br><br>
                        <input class="formText" type="phone" id="phone" name="phone" maxlength="12" placeholder="Phone Number (xxx-xxx-xxxx)" required> <span class="error">* <?php echo $phoneErr;?></span>
                        <br><br>
